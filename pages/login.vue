                      ...
                      <a-tabs default-active-key="1" v-model="tab" @change="signModel.username = ''">
                        <a-tab-pane key="1">
                          ...
                          <a-form ref="authForm" :model="signModel" :rules="setValidation.rules"
                            ...
                            <a-row>
                              <a-col :span="24">
                                <a-form-item has-feedback :label="$t('person.pd14')" name="username" :colon="false"
                                  :wrapper-col="{
                                    sm: { span: 24 }
                                  }">
                                  <a-input v-model:value="signModel.username" :placeholder="$t('placeholders.plh67')" />
                                </a-form-item>
                              </a-col>
                              ...
                              <a-col :span="24">
                                <a-form-item :label="$t('person.psd')" name="password" has-feedback :colon="false"
                                  ...
                                  <a-input-password v-model:value="signModel.password" name="password"
                            ...
                            <a-row>
                              ...
                              <a-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                                <a-form-item :label="$t('person.psd')" name="password" has-feedback :colon="false"
                                  ...
                                  <a-input-password v-model:valu="signModel.password" name="password"
                      ...
                      <a-row :gutter="16">
                        ...
                        <a-col :lg="12">
                          <a-button @click="appleLogin" class="cancel-outline-btn fw-5" block><img
                              src="/images/apple.svg" class="pr-2" />{{
                                $t('last.la14') }}</a-button>
                        </a-col>
                      </a-row>
                      <a-row class="mt-3">
                        <a-col :lg="24">
